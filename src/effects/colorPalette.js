...
export const colorPaletteEffect = {
    ...
    params: {
        ...
        palette0: { default: '#000000', label: 'Color 1', type: 'color' },
        palette1: { default: '#ff0000', label: 'Color 2', type: 'color' },
        palette2: { default: '#ff8800', label: 'Color 3', type: 'color' },
        palette3: { default: '#ffff00', label: 'Color 4', type: 'color' },
        palette4: { default: '#00ff00', label: 'Color 5', type: 'color' },
